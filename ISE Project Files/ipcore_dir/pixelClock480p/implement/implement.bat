...
xst -ifn xst.scr
move pixelClock480p_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\pixelClock480p.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc pixelClock480p.ucf pixelClock480p_exdes

echo 'Running map'
map -timing -pr b pixelClock480p_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm pixelClock480p_exdes -w routed.ncd routed.v
cd ..
