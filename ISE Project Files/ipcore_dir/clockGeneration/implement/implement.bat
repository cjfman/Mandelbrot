...
xst -ifn xst.scr
move clockGeneration_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\clockGeneration.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clockGeneration.ucf clockGeneration_exdes

echo 'Running map'
map -timing -pr b clockGeneration_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm clockGeneration_exdes -w routed.ncd routed.v
cd ..
